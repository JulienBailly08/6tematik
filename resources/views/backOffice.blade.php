...
@section('content')
    ...
    <h2 class="text-center">Gestion des véhicules</h2>

    <div class="container">
        <a class="my-4 btn btn-dark" href="{{ route('create') }}">Création d'un nouveau véhicule</a>
